...
using namespace winrt::Bitec;
using namespace winrt::Bitec::implementation;
...
void App::OnLaunched(activation::LaunchActivatedEventArgs const& e)
{
    ...
    configMap.Insert(L"ca217cfb-25f8-4905-af9c-c1e580fc1df2", L"<app deployment key>");
    ...
    if (rootFrame == nullptr)
    {
        ...
        if (e.PrelaunchActivated() == false)
        {
            if (rootFrame.Content() == nullptr)
            {
                ...
                // parameter
                rootFrame.Navigate(xaml_typename<Bitec::MainPage>(), box_value(e.Arguments()));
            }
